...
lxc_art = """
                                  ...
                                  {}_>  </__  Niggeroid
                                  {}/_/|_|  /_/    /_/    /_/{}
                               *annihilating niggers is our weapon*
                              ═══════════════════════════════════         
                         ═════════════════════════════════════════════
...
class x444:
    ...
    def menu(self):
        ...
        if ans in ["1", "01"]:
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Banned {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.banned), len(members)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Kicked {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.kicked), len(members)))
            time.sleep(1.5)
            self.menu()
            ...
            type = input("{}({}Lxc{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Created {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), amount))
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["5", "05"]:
            amount = int(input("{}({}Lxc{}) Amount{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")))
            self.roles.clear()
            for i in range(amount):
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Created {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Deleted {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), len(channels)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Deleted {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), len(roles)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Deleted {}/{} emojis".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.emojis), len(emojis)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Lxc{}) Spammed {}/{} messages".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.messages), amount))
            time.sleep(1.5)
            self.menu()
            ...
            try:
                ...
                if VERSION != check_version:
                    print("{}({}Lxc{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
                    webbrowser.open(f"https://github.com/notspeezy/x444-Nuker/releases/tag/{check_version}")
                else:
                    print("{}({}Lxc{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            except:
                print("{}({}Lxc{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            print("{}({}Lxc{}) Thanks for using Lxc Nuker".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
@__client__.event
async def on_ready():
    print("{}({}Lxc{}) Authenticated as{}: {}{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", f"{__client__.user.name}#{__client__.user.discriminator}"))
    time.sleep(1.5)
    x444().menu()
